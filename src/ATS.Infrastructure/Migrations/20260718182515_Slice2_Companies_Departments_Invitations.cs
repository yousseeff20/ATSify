...
namespace ATS.Infrastructure.Migrations;
    /// <inheritdoc />
    public partial class Slice2_Companies_Departments_Invitations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DomainUserRoles", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invitations_SecureToken",
                table: "Invitations",
                column: "SecureToken",
                unique: true);
        }
